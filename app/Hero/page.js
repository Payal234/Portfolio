...
export default function Hero() {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="bg-[#f8f9fa] text-gray-900 min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 py-12 md:py-20"
      >
        <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full max-w-6xl gap-8 md:gap-12">
          {/* Text Section */}
          <div className="w-full md:w-1/2 flex flex-col gap-4 text-center md:text-left">
            ...
            >
              I craft engaging web experiences as a{" "}
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
              <a
                ...
                className={`px-6 py-2 bg-indigo-600 text-white font-semibold rounded-full shadow-lg hover:bg-indigo-700 transition-all duration-500 transform ${
              ...
              <div className="flex gap-5 text-gray-700 text-2xl">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`hover:text-gray-900 transition-all duration-300 transform ${
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`hover:text-blue-700 transition-all duration-300 transform ${
                ...
                <a
                  ...
                  className={`hover:text-red-600 transition-all duration-300 transform ${
...
//       <section
//   id="home"
//   className="bg-[#f8f9fa] text-gray-900 min-h-screen flex items-center justify-center overflow-hidden px-4 py-8 md:py-16"
//       >
