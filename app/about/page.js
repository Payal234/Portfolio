...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-gray-50 to-gray-100 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <motion.h2
          ...
          className="text-3xl sm:text-4xl md:text-5xl font-bold text-indigo-700 mb-6 text-center"
        >
          About Me
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-gray-700 mb-12 sm:mb-16 text-center max-w-3xl mx-auto px-2"
        >
        ...
        {/* Education */}
        <h3 className="text-xl sm:text-2xl font-semibold text-indigo-600 mb-8 text-center">
          Education
        </h3>
        <motion.div
          variants={container}
        ...
        >
          {education.map((edu, idx) => (
            <motion.div
              ...
              className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg hover:shadow-2xl border border-gray-100"
            >
              ...
              <p className="text-indigo-600 font-medium mt-2 text-sm sm:text-base">
                {edu.cgpa}
              </p>
        ...
        >
          {skills.map((skill, idx) => (
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg p-5 sm:p-6 hover:shadow-2xl"
            >
              ...
              <ul className="space-y-2">
                {skill.items.map((itm, i) => (
                  <motion.li
                    ...
                    className="bg-gray-100 p-2 rounded-lg text-gray-700 text-sm sm:text-base text-center font-medium shadow-sm"
                  >
                    {itm}
                  </motion.li>
                ))}
