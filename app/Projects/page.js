...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="py-16 sm:py-20 bg-gradient-to-b from-gray-50 to-gray-100 px-4 sm:px-6 lg:px-12"
    >
      {/* Heading */}
      <motion.h2
        ...
        className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-10 sm:mb-12 text-indigo-700"
      >
        Projects
      </motion.h2>
      ...
      >
        {projects.map((project, idx) => (
          <motion.div
            ...
            className="bg-white border border-gray-200 p-5 sm:p-6 rounded-2xl shadow-md hover:shadow-xl transition flex flex-col"
          >
            ...
            <div className="flex gap-4 mt-auto relative">
              ...
              <motion.a
                ...
                className="text-gray-900 hover:text-gray-700 transition text-xl relative group p-2 rounded-lg"
                animate={{ y: [0, -4, 0] }}
                transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
              >
                <FaGithub />
                <span className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2 py-1 text-xs sm:text-sm bg-gray-800 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                  GitHub Repo
                </span>
              </motion.a>
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-indigo-600 hover:text-indigo-800 transition text-xl relative group p-2 rounded-lg"
                animate={{ y: [0, -4, 0] }}
                transition={{
                  duration: 2,
                  repeat: Infinity,
